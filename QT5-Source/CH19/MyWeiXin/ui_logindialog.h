...
public:
    ...
    void setupUi(QDialog *LoginDialog)
    {
        ...
        label->setPixmap(QPixmap(QString::fromUtf8("../../\345\276\256\344\277\241/img/login.jpg")));
    ...
    {
        LoginDialog->setWindowTitle(QApplication::translate("LoginDialog", "\345\276\256 \344\277\241 \345\256\242 \346\210\267 \347\253\257", nullptr));
